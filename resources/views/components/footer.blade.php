<footer class="bg-white dark:bg-gray-900 py-1.5">
    <div class="max-w-screen-xl mx-auto relative sm:flex sm:items-center justify-between px-4 sm:px-6 lg:px-8">
        <p class="font-mono text-sm font-normal leading-5 text-gray-500 dark:text-white">
            Inspiré de <a href="https://paste.laravel.io" class="text-laravel-io">Laravel IO</a>.
            Laravel Cameroun 2018 - {{ date('Y') }}
        </p>
        <div class="mt-5 sm:mt-0 flex items-center space-x-6">
            <div class="flex items-center space-x-4">
                <a href="https://twitter.com/laravelcm" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://github.com/laravelcm" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://facebook.com/laravelcm" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://www.linkedin.com/company/laravel-cameroun" class="text-gray-400 hover:text-gray-500">
                    <span class="sr-only">LinkedIn</span>
                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M5.004 7h-.029a2.235 2.235 0 1 1 .057-4.457A2.235 2.235 0 1 1 5.004 7zm2.014 3h-4v12h4V10zm10.5 0a4.472 4.472 0 0 0-3.5 1.703V10h-4v12h4v-5.5a2 2 0 0 1 4 0V22h4v-7.5a4.5 4.5 0 0 0-4.5-4.5z" />
                    </svg>
                </a>
            </div>
